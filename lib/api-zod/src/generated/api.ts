...
export const ListProductionEntriesResponseItem = zod
  .object({
    id: zod.string().uuid(),
...
export const GetProductionEntryResponse = zod
  .object({
    id: zod.string().uuid(),
    date: zod.coerce.date(),
    equipmentId: zod.string().uuid(),
...
export const UpdateProductionEntryResponse = zod
  .object({
    id: zod.string().uuid(),
    date: zod.coerce.date(),
    equipmentId: zod.string().uuid(),
...
export const SubmitProductionEntryResponse = zod
  .object({
    id: zod.string().uuid(),
    date: zod.coerce.date(),
    equipmentId: zod.string().uuid(),
...
export const ValidateProductionEntryResponse = zod
  .object({
    id: zod.string().uuid(),
    date: zod.coerce.date(),
    equipmentId: zod.string().uuid(),
...
export const GetDowntimeParetoQueryParams = zod.object({
  ...
  year: zod.coerce.number(),
  groupBy: zod
    .enum(["detail", "famille", "type"])
    .default(getDowntimeParetoQueryGroupByDefault)
    .describe(
      "How to group downtime events: detail=by category, famille=by family, type=by planned\/unplanned",
    ),
  isPlanned: zod.coerce
    .boolean()
    .optional()
    .describe("Filter by planned (true) or unplanned (false). Omit for all."),
});
 ...
 */
export const GetPendingValidationsResponseItem = zod
  .object({
    id: zod.string().uuid(),
    date: zod.coerce.date(),
    equipmentId: zod.string().uuid(),
